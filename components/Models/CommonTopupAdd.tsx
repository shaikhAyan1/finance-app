...
export default function CommonTopup({ visible, onVisible, children }: CommonTopupProps) {
    const [amount, setAmount] = useState("0");
    const [selectedCategory, setSelectedCategory] = useState("1");


    console.log("CommonTopup Rendered with visible:", visible);
        ...
        <>
            ...
            >
                <View className="flex-1 bg-black/50 justify-end">
                    <SafeAreaView
                        className="bg-white rounded-t-[32px] pt-3 flex flex-col justify-between relative"
                    ...
                    >
                        ...
                        <ScrollView showsVerticalScrollIndicator={false} className="flex-1 h-fit  relative">
                            {/* Amount */}
                            <View className="items-center mb-8 mt-15">
                            ...
                            {/* Date + Note */}
                            <View className="flex-row px-6 mb-8 mt-40 gap-3">
